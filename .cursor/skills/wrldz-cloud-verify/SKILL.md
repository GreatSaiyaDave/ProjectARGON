...
3. **Compiler version bump:** if you change `CardTextEffectCompiler.Version`, run `Tools/HeadlessEngine/run.sh --export-seed` so `compiled_effects_seed_v1.json` matches. Current Version is **53** (older notes may still say v48–v52).
