...
- After compiler `Version` bump: `Tools/HeadlessEngine/run.sh --export-seed` (`CardTextEffectCompiler.Version` is **51** as of 2026-09-23; older notes may say v48/v50)
- Default check: `Tools/HeadlessEngine/run.sh --quiet` (needs .NET 8)
- Card batches follow `CardEraCurriculum` set order (LOB → MRD → SRL …). Last batch: `Docs/CURRICULUM_BATCH_LOB_MRD1_2026-09-23.md` (LOB 100%, MRD 77.8%)
