...
## Response windows (added)

| Window | When | Player choice |
|--------|------|----------------|
| Attack declared | After attack declaration, before damage | Activate legal Trap/set QP or **Pass** |
| Monster summoned | After face-up NS/Tribute/Flip | Trap Hole / set QP or **Pass** |

See **RULES_ACCURACY.md** for honesty about scope vs full TCG.

## Explicitly NOT integrated (yet)

- Full multi-link chains / Spell Speeds / SEGOC
- Damage Step hand traps; Counter Traps as Speed 3 stack
- Complete continuous/lingering effect engine
- Special Summon procedures, Extra Deck (Fusion/Synchro/Xyz/Link)
- Field Zone, Pendulum Zones, Link arrows
- Banlist / limited cards
- Data-driven card text (still hardcoded starter IDs)
